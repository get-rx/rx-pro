...
/// Internal type Cond: defined at src/isa/pulley_shared/inst.isle line 100.
#[derive(Clone, Debug)]
pub enum Cond {
    If32 {
        reg: XReg,
...
pub fn constructor_raw_inst_to_inst<C: Context>(
    ...
    // Rule at src/isa/pulley_shared/inst.isle line 151.
    return v1;
}
...
pub fn constructor_load_ext_name_near<C: Context>(
    ...
    // Rule at src/isa/pulley_shared/inst.isle line 693.
    return v5;
}
...
pub fn constructor_load_ext_name<C: Context>(
    ...
    match arg2 {
        ...
        &RelocDistance::Far => {
            ...
            // Rule at src/isa/pulley_shared/inst.isle line 709.
            return v4;
        }
        _ => {}
    }
    unreachable!("no rule matched for term {} at {}; should it be partial?", "load_ext_name", "src/isa/pulley_shared/inst.isle line 706")
}
...
pub fn constructor_indirect_call_impl<C: Context>(
    ...
    // Rule at src/isa/pulley_shared/inst.isle line 736.
    return v2;
}
...
pub fn constructor_zext32<C: Context>(
    ...
    unreachable!("no rule matched for term {} at {}; should it be partial?", "zext32", "src/isa/pulley_shared/inst.isle line 757")
}
...
pub fn constructor_sext32<C: Context>(
    ...
    unreachable!("no rule matched for term {} at {}; should it be partial?", "sext32", "src/isa/pulley_shared/inst.isle line 764")
}
...
pub fn constructor_zext64<C: Context>(
    ...
    unreachable!("no rule matched for term {} at {}; should it be partial?", "zext64", "src/isa/pulley_shared/inst.isle line 771")
}
...
pub fn constructor_sext64<C: Context>(
    ...
    unreachable!("no rule matched for term {} at {}; should it be partial?", "sext64", "src/isa/pulley_shared/inst.isle line 778")
}
